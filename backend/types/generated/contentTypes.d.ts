...
export interface ApiAtracaoAtracao extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Atra\u00E7\u00F5es do parque';
    displayName: 'Atracao';
    pluralName: 'atracoes';
...
export interface ApiBeneficioBeneficio extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cards de benef\u00EDcios (Por que escolher)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descricao: Schema.Attribute.Text & Schema.Attribute.Required;
    gradiente: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiConfiguracaoSiteConfiguracaoSite
  ...
  info: {
    ...
    displayName: 'Configuracao do Site';
  ...
  attributes: {
    ...
    horario_semana: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'das 10h \u00E0s 22h'>;
    instagram_access_token: Schema.Attribute.String;
    instagram_url: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://www.instagram.com/divercity.park'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPrecoPreco extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Grupos de pre\u00E7os/passaportes';
    displayName: 'Preco';
    pluralName: 'precos';
    singularName: 'preco';
  };
